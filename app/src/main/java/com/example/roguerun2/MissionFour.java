...
public class MissionFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mission_four);
        button();
        timerTextView = findViewById(R.id.timer5);
    ...
    public void button(){
        final Button button = findViewById(R.id.startworkout4);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                databaseReference = FirebaseDatabase.getInstance().getReference();
                newUser = new User(UserStats.getID(),UserStats.getAge(),UserStats.getHeight(),UserStats.getBmi(),UserStats.getWeight(),UserStats.getBodyFat(), UserStats.getWorkOut1(),UserStats.getWorkOut2(),UserStats.getWorkOut3(),true);
