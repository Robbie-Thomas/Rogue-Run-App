...
public class MissionTwo extends AppCompatActivity {
    ...
    public void test(){
        ...
        workout = findViewById(R.id.StartWorkout);
        workout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                databaseReference = FirebaseDatabase.getInstance().getReference();
                newUser = new User(UserStats.getID(),UserStats.getAge(),UserStats.getHeight(),UserStats.getBmi(),UserStats.getWeight(),UserStats.getBodyFat(), UserStats.getWorkOut1(),true,UserStats.getWorkOut3(),UserStats.getWorkOut4());
    ...
    public void createShareButton(){
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String shareBody = "I have just completed Mission Two on Rogue Run";
